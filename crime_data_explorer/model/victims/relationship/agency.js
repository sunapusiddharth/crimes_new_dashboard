...
var VictimsRelationshipAgencySchema = new mongoose.Schema({  
    acquaintance:Number,
    babysittee:Number,
...
mongoose.model('victims_relationship_agency', VictimsRelationshipAgencySchema);

module.exports = mongoose.model('victims_relationship_agency');