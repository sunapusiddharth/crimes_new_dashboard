...
var PoliceEmplymentStateSchema = new mongoose.Schema({  
    data_year:Number,
    civilian_ct:Number,
...
mongoose.model('police_employment_state', PoliceEmplymentStateSchema);

module.exports = mongoose.model('police_employment_state');