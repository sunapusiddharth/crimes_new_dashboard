...
export class SearchAllDepartments extends Component {
    constructor(props) {
        super(props);
        this.state = { offset: 0 };
        this.ref = createRef()
    ...
    componentDidMount() {
        this.props.dispatch(fetchCrimeNewsSearch("fbi", 0, 5,0))
    }

    handleClick(offset) {
        this.setState({ offset })
        this.props.dispatch(fetchCrimeNewsSearch("fbi",offset, 5,0))
...
export default connect(mapStateToProps, null)(SearchAllDepartments)
