...
function Introduction(props) {
    ...
    return (
        <div>
            <h2>{props.state}</h2>
            <hr />
            <p>Police Employment data for the nation are derived from  summary (SRS)  glossary lookup  and  incident (NIBRS)  glossary lookup reports voluntarily submitted to the FBI.</p>
            <p>{data_collection}</p>
        </div>
    )
}
