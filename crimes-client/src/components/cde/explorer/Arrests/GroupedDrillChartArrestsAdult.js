...
export default class GroupedDrillChartArrestsAdult extends Component {
    constructor(props) {
        super(props)
    }
    ...
    highChartsRender(chart_data) {
        Highcharts.chart({
            chart: {
                type: 'column',
                renderTo: 'container_adult_summary'
            },
            title: {
    ...
    render() {
        ...
        return (
            <Fragment>
            <div id="container_adult_summary" style={{minWidth: "890px", height: "800px", margin: "0 auto"}}>
            </div>
            </Fragment>
