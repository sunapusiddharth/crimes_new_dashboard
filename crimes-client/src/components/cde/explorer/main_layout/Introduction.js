...
function Introduction(props) {
    ...
    let data_collection = `In ${props.end_year_main}, the FBI  estimated  glossary lookup  crime statistics for the nation are based on data received from ${thousand_separator(agencies_count)} law enforcement agencies in the country that year.`
    ...
    return (
        <div>
            <h2>{props.selected_state}</h2>
            <hr />
            <p>Crime data for the nation are derived from summary (SRS)  glossary lookup  and  incident (NIBRS)  glossary lookup  reports voluntarily submitted to the FBI.</p>
