...
import '../styles/line_graph_d3.css'

    Gradient = function(){
        return(
            <defs>
                <linearGradient is id={this.props.id} x1="0%" y1="100%" x2="0%" y2="0%" spreadMethod="pad">
                    <stop is offset="10%" stop-color={this.props.color1} stop-opacity={0}/>
                    <stop is offset="80%" stop-color={this.props.color2} stop-opacity={0}/>
                </linearGradient>
            </defs>
        );
    }
...
class resizeMixin extends Component{
    componentWillMount(){
...
export default LineGraphD3 = function(){
        return(
