...
import '../styles/custom_pagination.css'
    ...
    render() {
        ...
        return (
            <Pagination>
                ...
                <Pagination.Item key={index} className={pager.currentPage === page ? 'active' : ''} onClick={() => this.setPage(page)}>
                        {page}
                </Pagination.Item>
...
export default connect(mapStateToProps, null)(CustomPagination)
